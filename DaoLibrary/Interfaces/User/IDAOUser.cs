...
namespace DaoLibrary.Interfaces.User;
    ...
    {
        Task<(List<EntitiesLibrary.User.User> Users, int TotalCount)> GetUsersPaged (int pageNumber, int pageSize, string? searchTerm,  EntitiesLibrary.Common.EntityStatus? entityStatus = null);
