...
{
    Task<(List<EntitiesLibrary.Comment.Comment> Comments, int TotalCount)> GetCommentsPaged
        (int pageNumber, int pageSize, int idPost, EntitiesLibrary.Common.EntityStatus? entityStatus = null);
